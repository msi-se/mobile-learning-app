...
import 'package:frontend/components/privacy_approval.dart';
                  ...
                  return Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 20),
                        const Text(
                            'Melden Sie sich mit Ihren HTWG-Zugangsdaten an',
                            textAlign: TextAlign.center,
                            style:
                                TextStyle(fontSize: 16)), // Hinzugefügter Text
                        const SizedBox(height: 20),
                        _buildLoginField(
                            title: 'Benutzername',
                            hintText: 'z.B. ma871mu',
                        ...
                        _isLoading
                            ...
                            : SubmitButton(
                                onTap: _isChecked ? _signInUser : null,
                                enabled: _isChecked,
                              ),
                        const SizedBox(height: 20),
                      ],
