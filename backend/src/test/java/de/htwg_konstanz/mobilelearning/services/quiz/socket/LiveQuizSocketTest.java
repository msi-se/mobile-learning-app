...
public class LiveQuizSocketTest {
    ...
    public void testScoreAndResult() throws DeploymentException, IOException, InterruptedException {
        ...
        Assertions.assertEquals(10, courseService.getCourse(courseId).getQuizForms().get(0).getParticipants().get(0).getScore());
        Assertions.assertEquals(10, courseService.getCourse(courseId).getQuizForms().get(0).getParticipants().get(1).getScore());
